...
namespace HoaiNXRazorPages.Infrastructure.Data;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NewsTag>(entity =>
        {
            ...
            entity.HasOne(d => d.NewsArticle)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull) // or DeleteBehavior.Cascade if you want cascading deletes
       ...
       .UsingEntity<NewsTag>(
           ...
           r => r.HasOne(x => x.NewsArticle).WithMany().HasForeignKey(x => x.NewsArticleId)
       );
